...
_main:
; .FSTART _main
; 0000 0048     DDRA    = 0xff ; // 1111 1111
	LDI  R30,LOW(255)
	OUT  0x1A,R30
; 0000 0049     PORTA   = 0x00 ; // 0000 0000
	LDI  R30,LOW(0)
	OUT  0x1B,R30
; 0000 004A 
; 0000 004B     DDRC    = 0x83 ; // 1000 0011
	LDI  R30,LOW(131)
	OUT  0x14,R30
; 0000 004C     PORTC   = 0x7C ; // 0111 1100
	LDI  R30,LOW(124)
	OUT  0x15,R30
; 0000 004D 
; 0000 004E     DDRD    = 0xff ;
...
; 0000 0057                    i1= a;
	MOV  R6,R8
; 0000 0058                    for (i2=0; i2 < 4; i2++){
	CLR  R9
_0x10:
	LDI  R30,LOW(4)
	CP   R9,R30
	BRSH _0x11
; 0000 0059                         arr1[i2] =   i1%2 ;
	MOV  R30,R9
	LDI  R31,0
	SUBI R30,LOW(-_arr1)
	SBCI R31,HIGH(-_arr1)
...
; 0000 006D                    delay_ms(10);
	RCALL SUBOPT_0x0
; 0000 006E                    for (b = a%3 ; b < 16 ; b = b+3){
	MOV  R26,R8
	CLR  R27
	LDI  R30,LOW(3)
	LDI  R31,HIGH(3)
...
; 0000 006F                          i1= b ;
	MOV  R6,R11
; 0000 0070                         for (i2=0; i2 < 4; i2++){//0011
	CLR  R9
_0x1E:
	LDI  R30,LOW(4)
	CP   R9,R30
	BRSH _0x1F
; 0000 0071                              arr2[i2] =   i1%2;
	MOV  R30,R9
	LDI  R31,0
	SUBI R30,LOW(-_arr2)
	SBCI R31,HIGH(-_arr2)
...
; 0000 0087                         temp = a + b + CI;
	...
	MOV  R7,R30
; 0000 0088 
; 0000 0089                         for (i2=0; i2 < 5; i2++){
	CLR  R9
_0x29:
	LDI  R30,LOW(5)
	CP   R9,R30
	BRSH _0x2A
; 0000 008A                              arr3[i2] =   temp%2;
	MOV  R30,R9
	LDI  R31,0
	SUBI R30,LOW(-_arr3)
	SBCI R31,HIGH(-_arr3)
...
; 0000 0098                         delay_ms(10);
	RCALL SUBOPT_0x0
; 0000 0099                         if(S1 == arr3[4] && S2 == arr3[3] && S3==arr3[2] && S4==arr3[1]){
	RCALL SUBOPT_0x2
	BRNE _0x2C
	RCALL SUBOPT_0x3
	BRNE _0x2C
...
; 0000 009A                             LED_GREEN = ON;
	SBI  0x12,2
; 0000 009B                             delay_ms(50);
	LDI  R26,LOW(50)
	LDI  R27,0
	CALL _delay_ms
; 0000 009C                             LED_GREEN = OFF;
	CBI  0x12,2
; 0000 009D                             test = ON;
	LDI  R30,LOW(1)
	MOV  R5,R30
; 0000 009E                         }
; 0000 009F                         else if(S1!=arr3[4] || S2!=arr3[3] || S3!=arr3[2] || S4!=arr3[1]) {
	RJMP _0x32
_0x2B:
	RCALL SUBOPT_0x2
	BRNE _0x34
	...
	BREQ _0x33
_0x34:
; 0000 00A0                             LED_RED = ON;
	SBI  0x12,3
; 0000 00A1                             delay_ms(50);
	LDI  R26,LOW(50)
	LDI  R27,0
	CALL _delay_ms
; 0000 00A2                             LED_RED = OFF;
	CBI  0x12,3
; 0000 00A3                             test = OFF;
	CLR  R5
; 0000 00A4                             //break;
...
; 0000 00AF         if(test == 1){
	...
	CP   R30,R5
	BRNE _0x3C
; 0000 00B0               LED_RED = OFF;
	CBI  0x12,3
; 0000 00B1               LED_GREEN = ON;
	SBI  0x12,2
; 0000 00B2         }
; 0000 00B3         else if(test == 0){
	RJMP _0x41
_0x3C:
	TST  R5
	BRNE _0x42
; 0000 00B4             LED_GREEN = OFF;
	CBI  0x12,2
