...
; 0000 0037     LED = OFF;
	CBI  0x12,3
; 0000 0038     UART_SendString("a");
	__POINTW2MN _0x10,0
	RCALL _UART_SendString
; 0000 0039     UART_TxChar('b');
	LDI  R26,LOW(98)
	RCALL _UART_TxChar
; 0000 003A     while(1)
_0x11:
...
; 0000 003C         UART_init();
	RCALL _UART_init
; 0000 003D         c[0] = UART_RxChar();
	RCALL _UART_RxChar
	ST   Y,R30
; 0000 003E         UART_TxChar(c[0]);
	LD   R26,Y
	RCALL _UART_TxChar
; 0000 003F 
; 0000 0040         if(c[0]== '1'){
...
; 0000 004F         puts("5");
	...
	CALL _puts
; 0000 0050 
; 0000 0051         //UART_SendString("0");
; 0000 0052         //UART_SendString("0");
; 0000 0053         //UART_SendString("7");
; 0000 0054         //UART_SendString(c);
; 0000 0055         //UART_SendString("\r \n");
